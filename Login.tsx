...
const LoginShow: React.FunctionComponent = () => {
  ...
  const signUpForAccountMessage = (
    <LoginMainFooterBandItem className="font-bold font-serif">
      Need an account?
      <a href="#" className="hover:text-blue-500 ml-1">
        Sign up.
      </a>
    </LoginMainFooterBandItem>
  );
  ...
  const loginForm = (
    <LoginForm
      ...
      helperTextIcon={<ExclamationCircleIcon className="mt-0.5" />}
  ...
  return (
    <LoginPage
      className="login font-serif"
      footerListVariants={ListVariant.inline}
      brandImgSrc={logo}
      loginTitle={
        <div className="login-title ml-4">Log in to your account</div>
      }
      loginSubtitle={
